...
public class Set implements Embedded {
    ...
    private Set(String name, String level, String bonusTotal, String skinURL, String url, String composition,
    ...
    public EmbedObject getMoreEmbedObject() {
        ...
        if (bonusTotal != null && ! bonusTotal.isEmpty())
            builder.appendField(":cyclone: Bonus total de la panoplie complète :", bonusTotal, true);
