...
public enum Transport {
    ...
    CITE_D_ASTRUB("transport.type.zaap", "transport.zone.astrub", "transport.souszone.cite_astrub", Position.of(5,-18), true),
    ...
    BRIGANDIN_PÉNINSULE_GELEES("transport.type.brigandin","","",Position.of(11,30), true),
    ...
    Transport(String type, String zone, String sousZone, Position position, boolean isAvailableUnderConditions) {
        this.type = type;
        this.zone = zone;
